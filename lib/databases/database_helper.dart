...
class DatabaseHelper {
  ...
  static Future<int> save(String name, String email, String password) async {
    ...
    final id =
        await db.insert('person_info', {'full_name': name, "email": email,"password":password});
    return id;
  }
  ...
  static Future<int> update(int id,String name, String email, String password) async {
    final db = await DatabaseHelper.openDb();
